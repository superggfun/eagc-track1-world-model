...
def _commands(tier: str, seed: int, difficulty: str) -> List[List[str]]:
    ...
    check_source_package = [py, "tools/check_source_package_repro.py", "--zip-path", "dist/source.zip"]
    ...
    maze_easy_validate = [py, "-m", "validators.validate_maze_outputs", "--output-dir", "outputs/maze_stress/simple_t_maze", "--recursive"]
    maze_medium = [
        py,
        "tools/run_maze_stress_test.py",
        "--episode",
    ...
    maze_medium_validate = [py, "-m", "validators.validate_maze_outputs", "--output-dir", "outputs/maze_stress", "--recursive"]
    maze_anti_loop = [
        py,
    ...
    maze_anti_loop_validate = [py, "-m", "validators.validate_maze_outputs", "--output-dir", "outputs/maze_anti_loop", "--recursive"]
    targeted_replay = [
        py,
