...
- Vision support currently covers single-image smoke testing and does not yet provide robust multi-frame visual world-model updates.
...
- v0.9: multi-frame visual sequence world-model updates with temporal consistency checks.
