# v0.8.4 Technical Report: EAGC Track 1 LocalSim MVP

Generated: 2026-06-10 06:01:05 UTC

Git commit: `fdc080a`

Git tag/describe: `v0.8.3-test-guardrails-frontier-exploration`
...
| Run | success_rate | complete_count | blocked_recovered_count | accepted_failure_count | failed_count | average_local_heuristic_score | fallback_used_count | hidden_spec_leakage_detected | average_qwen_calls | average_latency_seconds |
|---|---|---|---|---|---|---|---|---|---|---|
| easy mock | 1.0 | 75 | 25 | 0 | 0 | 96.25 | 0 | not available | 0.0 | 0.0258 |
| easy real | 1.0 | 15 | 5 | 0 | 0 | 96.25 | 0 | not available | 14.85 | 98.05 |
| medium real | 1.0 | 1 | 0 | 0 | 0 | 100.0 | 0 | False | 21.0 | 185.0225 |
| medium latest | 0.9167 | 8 | 2 | 1 | 1 | 89.5833 | 0 | not available | 0.0 | 0.0284 |
